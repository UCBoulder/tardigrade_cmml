...
namespace tardigradeCMML {
    ...
    namespace BasicSolid {
        ...
        void BasicSolid::formDeformationGradients(const current_dof_type         *current_dof_begin,
        ...
        int BasicSolid::evaluate_model(const time_type &current_time, const time_type &dt,
