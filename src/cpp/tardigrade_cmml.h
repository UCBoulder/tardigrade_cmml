...
namespace tardigradeCMML {
    ...
    template <class TCMMLMaterial>
    std::unique_ptr<CMMLMaterial> MaterialRegistrar<TCMMLMaterial>::GetMaterial() {
        /*!
...
#define REGISTER_MATERIAL(CLASSNAME)                                                \
    namespace {                                                                     \
        static tardigradeCMML::MaterialRegistrar<CLASSNAME> _registrar(#CLASSNAME); \
    }
